...
(function() {
  ...
  keypress.Listener = (function() {
    function Listener(element, defaults) {
      ...
      this.wintop = window.top || window;
      this.element = this.wintop.document.body;
      ...
      this.blur_event = attach_handler(this.wintop, "blur", (function(_this) {
        return function() {
    ...
    Listener.prototype.destroy = function() {
      ...
      return remove_handler(this.wintop, "blur", this.blur_event);
    };
